...
class GetCheckIsAppointment @Inject constructor(
    private val repository: MyRepository
) {
    operator fun invoke(
        serviceId: String,): Flow<Resource<SelectService>> = flow {
        try {
          ...
          // var selectServices = repository.checkIsAppointment(serviceId)
